...
export interface ElectronApi {
  ...
  doclingService: {
    getStatus: () => Promise<DoclingServiceStatus>
    ensureRunning: () => Promise<DoclingServiceStatus>
    stop: () => Promise<DoclingServiceStatus>
  ...
  doclingModels: {
    getStatus: () => Promise<DoclingModelStatusInfo>
    download: () => Promise<DoclingModelStatusInfo>
    delete: () => Promise<DoclingModelStatusInfo>
