export const IPC_CHANNELS = {
  ...
  GET_SMART_CACHE_INFO: 'get-smart-cache-info',
  SET_CACHE_AUTO_CLEAN: 'set-cache-auto-clean',
  GET_CACHE_AUTO_CLEAN: 'get-cache-auto-clean',
  SMART_CACHE_ACTION: 'smart-cache-action',
