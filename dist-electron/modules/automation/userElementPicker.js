...
exports.generatePickerScript = void 0;
const styles_1 = require("./picker/styles");
const domHelpers_1 = require("./picker/domHelpers");
const uiTemplates_1 = require("./picker/uiTemplates");
/**
 ...
 */
const generatePickerScript = (translations = {}) => {
    return `
    (function() {
        ...
        const getElementInfo = ${domHelpers_1.getElementInfo.toString()};
        const generateRobustSelector = ${domHelpers_1.generateRobustSelector.toString()};
        const getStepHtml = ${uiTemplates_1.getStepHtml.toString()};
        const getHintHtml = ${uiTemplates_1.getHintHtml.toString()};
        ...
        style.textContent = \`${styles_1.pickerStyles}\`;
...
exports.generatePickerScript = generatePickerScript;
