...
exports.getHintHtml = exports.getStepHtml = void 0;
const getStepHtml = (step, t = {}) => {
...
const getHintHtml = (step, hoveredInfo, t = {}) => {
    if (!hoveredInfo || (step !== 'input' && step !== 'submit'))
        return '';
...
exports.getHintHtml = getHintHtml;
