...
export function useGeminiWebStatus(
    options?: Omit<UseQueryOptions<GeminiWebSessionStatus, Error, GeminiWebSessionStatus>, 'queryKey' | 'queryFn'>
) {
...
function useGeminiWebMutation<Payload>(
    ...
    return useElectronMutation<GeminiWebSessionActionResult, Payload>(
        action,
        {
