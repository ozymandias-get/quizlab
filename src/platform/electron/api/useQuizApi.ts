...
export function useCheckAuth(
  options?: Omit<UseQueryOptions<QuizAuthResult, Error, QuizAuthResult>, 'queryKey' | 'queryFn'>
) {
...
export function useOpenLogin() {
  const { t } = useLanguage()
  return useElectronMutation<QuizActionResult, void>((api) => api.quiz.openLogin(), {
...
export function useLogout() {
  ...
  return useElectronMutation<QuizActionResult, void>((api) => api.quiz.logout(), {
