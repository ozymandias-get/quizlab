...
vi.mock('@ui/components/Icons', () => ({
    TerminalIcon: ({ className }: { className?: string }) => <span className={className}>TerminalIcon</span>,
    ...
    GoogleIcon: ({ className }: { className?: string }) => <span className={className}>GoogleIcon</span>,
