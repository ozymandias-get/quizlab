...
export const useLanguage = create<LanguageState>((set, get) => ({
  ...
  t: (key: string, params: Record<string, string> = {}) => {
    ...
    const translationData = (translations[language as keyof typeof translations] ||
      translations[DEFAULT_LANGUAGE as keyof typeof translations]) as Record<string, unknown>
    const defaultTranslationData = translations[
      DEFAULT_LANGUAGE as keyof typeof translations
    ] as Record<string, unknown>

    const rawTranslation =
      getNestedValue(translationData, key) || getNestedValue(defaultTranslationData, key) || key
