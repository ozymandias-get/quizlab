    ...
    return (
        <div className="relative border-b border-white/[0.06] px-4 py-3">
            <motion.button
                ...
                style={autoSend ? {
                    background: 'linear-gradient(145deg, rgba(16,185,129,0.16), rgba(16,185,129,0.04) 55%, rgba(255,255,255,0.02))',
                    boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.05), 0 16px 28px -16px rgba(16,185,129,0.45)'
                } : {
                    background: 'linear-gradient(145deg, rgba(255,255,255,0.04), rgba(255,255,255,0.015) 60%, rgba(255,255,255,0.01))',
            ...
            >
                ...
                <motion.div layout={shouldAnimateLayout} className="relative z-10 flex items-start justify-between gap-4">
