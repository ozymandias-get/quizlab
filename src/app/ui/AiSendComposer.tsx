...
function AiSendComposer({
    ...
    const handleSubmit = useCallback(async (options?: { autoSend?: boolean }) => {
        ...
        try {
            ...
            const wasSuccessful = typeof result === 'object'
                && result !== null
                && 'success' in result
            ...
            {!isDismissed ? (
                ...
                >
                    ...
                    >
                        ...
                        <div className="pointer-events-none absolute inset-0" style={{ background: sectionSurface, opacity: 0.72 }} />
                        <div className="pointer-events-none absolute inset-0" style={{ background: panelGlowBackground }} />
