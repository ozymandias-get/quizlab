            ...
            <AnimatePresence>
                {tabsCount > 1 && !isOpen && (
                    <motion.div
                        ...
                        className="hub-center-btn__badge absolute -top-1 -right-1 flex items-center justify-center w-4 h-4 rounded-full text-[9px] font-bold text-white shadow-lg pointer-events-none z-20"
                    >
                        {tabsCount}
                    </motion.div>
                )}
