      ...
      <div className="flex flex-col gap-5">
        ...
        >
          <div className={isCompact ? 'max-w-none' : 'max-w-2xl'}>
            ...
            <h1
              className={`mt-4 font-semibold tracking-tight text-white/92 ${
                isUltraNarrow
            ...
            <p
              className={`mt-3 text-[13.5px] leading-relaxed text-white/48 ${isCompact ? 'max-w-none' : 'max-w-xl'} sm:text-[14.5px]`}
            >
            ...
            <div className="mt-3 flex flex-wrap gap-2.5">
              {featuredIds.map((id) => (
                <button
                  ...
                  className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[11px] text-white/70 transition-colors hover:bg-white/[0.08] hover:text-white/90"
                >
