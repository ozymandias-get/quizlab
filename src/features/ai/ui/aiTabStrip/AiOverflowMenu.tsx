    ...
    <div ref={overflowRef} className="relative ml-auto shrink-0">
      ...
      {isOverflowOpen && (
        <motion.div
          ...
          className="absolute right-0 top-10 z-40 w-[260px] max-h-56 overflow-y-auto rounded-xl border border-white/15 bg-[#080808]/95 backdrop-blur-lg shadow-xl shadow-black/60 p-1.5"
        >
