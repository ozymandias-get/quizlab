        ...
        <div ref={pageRef} className="absolute inset-0 overflow-y-auto overflow-x-hidden custom-scrollbar">
            <div className="relative min-h-full px-4 py-4 sm:px-5 sm:py-5">
                ...
                <div className="relative z-10 flex flex-col gap-4">
                    ...
                    <AiHomeSection title={t('ai_home.models_title')} detail={t('ai_home.models_detail')} icon={<Sparkles className="h-4 w-4" />} accent="#7c8cff" delay={0.09} defaultOpen={true}>
                        <AiHomeCardGrid
                    ...
                    <AiHomeSection title={t('ai_home.sites_title')} detail={t('ai_home.sites_detail')} icon={<Globe className="h-4 w-4" />} accent="#f3b24f" delay={0.13} defaultOpen={false}>
                        {siteOrder.length > 0 ? (
                            <AiHomeCardGrid
                                activeModelIds={activeModelIds}
                                aiSites={aiSites}
