...
import { CheckCircle, XCircle, AlertCircle, ChevronDown, Sparkles } from 'lucide-react'
import { formatQuizText } from '@shared/lib/uiUtils'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ChevronDown
          className={`w-4 h-4 text-white/40 shrink-0 transition-transform ${isExpanded ? 'rotate-180' : ''}`}
        />
      </button>
              ...
              <div className="space-y-2">
                {q.options.map((opt, optIdx) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`font-bold shrink-0 ${isCorrectAnswer ? 'text-emerald-400' : isUserChoice ? 'text-red-400' : 'text-white/40'}`}
                      >
