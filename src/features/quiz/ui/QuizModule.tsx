...
import { QuizStep } from '../model/types'
...
function QuizModule({ onClose, initialPdfPath = '', initialPdfName = '' }: QuizModuleProps) {
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          'linear-gradient(135deg, rgba(12, 10, 9, 0.98) 0%, rgba(28, 25, 23, 0.99) 50%, rgba(12, 10, 9, 0.98) 100%)'
      }}
    >
      {/* Header */}
      ...
      <main className="flex-1 overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          {step === QuizStep.GENERATING && (
            <QuizGenerating key="generating" message={loadingMessage} t={t} />
          )}
