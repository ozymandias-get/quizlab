/**
 * Minimal safe Markdown → HTML conversion for OCR results.
 *
 * Pure, stateless domain logic extracted from `MarkdownRenderer.tsx` so it can
 * be tested independently of React. Covers: headings, bold, italic, lists,
 * blockquote, code, tables, hr, links, math.
 *
 * LaTeX ($...$ and $$...$$) is preserved and rendered as styled inline code
 * if KaTeX is not present.
 */
