...
function GeminiWebRiskNotice({
    t,
    riskItems,
    mitigationItems
}: GeminiWebRiskNoticeProps) {
    return (
        <div className="rounded-xl border border-rose-500/30 bg-rose-500/10 p-4">
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                    <p className="text-sm font-bold text-rose-100/90">{t('gws_warning_title')}</p>
                    <p className="mt-1 text-xs leading-relaxed text-rose-100/70">{t('gws_warning_intro')}</p>
