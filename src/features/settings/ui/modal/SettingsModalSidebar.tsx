...
import { SurfaceCard, ListItemCard, ActionRow } from '@shared/ui/components/primitives'
                  ...
                  {section.tabs.map((tab) => {
                    ...
                    return (
                      <ListItemCard
                        ...
                        aria-controls={SETTINGS_MODAL_MAIN_PANEL_ID}
                        aria-selected={selected}
                        onClick={() => setActiveTab(tab.id)}
                        active={selected}
                        className={`group relative isolate overflow-hidden outline-none transition-all duration-300 focus-visible:ring-2 focus-visible:ring-white/25 focus-visible:ring-offset-2 focus-visible:ring-offset-[#080808] p-3 ${
                          selected
                            ? 'text-white border-white/[0.18] shadow-[inset_0_1px_0_rgba(255,255,255,0.14),0_16px_34px_-26px_rgba(0,0,0,0.9)]'
                            : 'text-white/58 hover:text-white/88 hover:border-white/[0.14]'
                        }`}
                        style={
                          selected
                            ? {
                      ...
                      >
                        ...
                        <ActionRow>
                          ...
                          <div className="relative z-10 min-w-0 flex-1 ml-1 text-left">
                            <span className="block truncate text-ql-14 font-semibold tracking-tight">
                              {tab.label}
                            </span>
                          </div>
                          <ChevronRightIcon
