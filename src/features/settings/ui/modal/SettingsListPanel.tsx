                ...
                {activeSection.tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group focus-visible:ring-ring focus-visible:ring-offset-background relative flex w-full items-center gap-2.5 rounded-lg border p-3 text-left transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
                        isSelected
                    ...
                    >
                      ...
                      <span className="text-muted-foreground/30 shrink-0 text-sm">›</span>
                    </button>
                  )
                })}
              </div>
