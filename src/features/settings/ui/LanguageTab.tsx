                        ...
                        {({ checked }) => (
                            <>
                                ...
                                <div className="flex-1 space-y-0.5">
                                    <Label className={`block text-sm font-bold transition-colors duration-300 ${checked ? 'text-white' : 'text-white/50 group-hover:text-white/70'}`}>
                                        {lang.nativeName}
                                    </Label>
                                    <span className={`block text-[10px] font-bold uppercase tracking-widest transition-colors duration-300 ${checked ? 'text-white/40' : 'text-white/20'}`}>
                                        {lang.name}
                                    </span>
                                </div>
