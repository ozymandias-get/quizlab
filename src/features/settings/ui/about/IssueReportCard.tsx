    ...
    <AboutActionCard
      ...
      trailing={
        <button
          onClick={handleCopy}
          disabled={isCopying}
          className="flex items-center gap-2 rounded-xl border border-blue-500/20 bg-blue-500/10 px-5 py-2.5 text-ql-11 font-semibold text-blue-400 transition-all hover:bg-blue-500/20 disabled:opacity-60"
        >
