...
const TOGGLE_SIZE_CLASSES: Record<SettingsToggleSwitchSize, { root: string; knob: string; checked: string; unchecked: string }> = {
    md: {
        root: 'h-6 w-11 p-1',
        ...
        >
            <span
                className={cn(
                    ...
                    sizeClasses.knob,
                    checked ? `${sizeClasses.checked} bg-emerald-500` : `${sizeClasses.unchecked} bg-white/20`,
                    knobClassName
                )}
            />
        </Switch>
