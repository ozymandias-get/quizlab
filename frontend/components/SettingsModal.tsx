...
import { SettingsIcon, CloseIcon, LanguageIcon, InfoIcon, GridIcon, EyeIcon, MagicWandIcon } from './Icons'

// Lazy Load Settings Tabs
const LanguageTab = lazy(() => import('./settings/LanguageTab'))
...
const SelectorsTab = lazy(() => import('./settings/SelectorsTab'))
const GeminiCliTab = lazy(() => import('./settings/GeminiCliTab'))
const PromptsTab = lazy(() => import('./settings/PromptsTab'))
