...
<p align="center">
  <img src="https://img.shields.io/badge/s%C3%BCr%C3%BCm-2.2.5-blue.svg?style=flat-square" alt="QuizLab Reader sürüm 2.2.5" />
...
QuizLab Reader; PDF okuyucu, yapay zeka web çalışma alanı ve interaktif quiz üreticisini tek bir Electron masaüstü uygulamasında birleştiren ücretsiz ve açık kaynaklı bir yazılımdır. Tıp öğrencileri, sınav adayları, araştırmacılar ve PDF ile yoğun çalışan kullanıcılar için pasif okumayı aktif hatırlamaya çevirmeyi hedefler.
...
## Neden QuizLab Reader — Yapay Zeka Destekli Çalışma Alanı
...
### Yapay Zeka Destekli Quiz Üretici — Aktif Hatırlama
...
<p align="center">
  <strong>Anahtar Kelimeler:</strong> yapay zeka PDF okuyucu, quiz üretici, çalışma aracı, aktif hatırlama, sınav hazırlık, flashcard üretici, Electron uygulaması, bölünmüş ekran PDF, Gemini AI, ChatGPT entegrasyonu, tıp çalışma uygulaması, açık kaynak çalışma alanı, PDF açıklama aracı, yapay zeka destekli öğrenme, çapraz platform masaüstü uygulaması
</p>
