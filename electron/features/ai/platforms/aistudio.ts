...
export default {
  ...
  selectors: {
    input:
      'textarea, ms-autosize-textarea textarea, div[contenteditable=\"true\"][role=\"textbox\"], div[role=\"textbox\"]',
    button:
      'button[aria-label*=\"Run\" i], button[aria-label*=\"Generate\" i], button[aria-label*=\"Send\" i], button[aria-label*=\"Submit\" i]',
