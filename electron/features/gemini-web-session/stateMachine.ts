...
export function createDefaultStatus(featureEnabled: boolean, enabled: boolean = featureEnabled): GeminiWebSessionStatus {
    return {
        state: 'uninitialized',
        lastHealthyAt: null,
        lastCheckAt: null,
...
function stateForFailure(kind: ProbeKind, failureCount: number, maxConsecutiveFailures: number): GeminiWebSessionState {
